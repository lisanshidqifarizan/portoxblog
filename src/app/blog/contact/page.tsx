...
export const metadata: Metadata = {
    ...
    authors: [{ name: "Lisan Shidqi Farizan", url: "https://veoveneht.eu.org/contact" }],
};

export default function Contact() {
    return (
        <div className="max-w-2xl mx-auto mt-10 p-6 bg-white border-4 border-black shadow-[6px_6px_0_0_#000]">
            <h1 className="text-4xl font-extrabold text-black mb-4">📬 Contact Us</h1>

            <p className="text-gray-800 mb-6">
                Have questions, suggestions, or want to collaborate? Send us your message using the form below. We will respond as soon as possible!
            </p>
