	...
	return (
		<main className="w-full h-[100vh] flex justify-center items-center">
			<div className="max-w-4xl p-6 bg-white border-4 border-black shadow-[6px_6px_0px_0px_#000]">
				<h1 className="text-4xl font-extrabold mb-6 text-black border-b-2">
				...
				<div className="space-y-6">
					<div>
						...
						<p className="text-base text-gray-800">
							VEOveneht is a site that provides content about coding tutorials,
							game news, the latest technology, and other interesting articles.
						</p>
					</div>
					...
					<div>
						<h2 className="text-xl font-bold text-black">
							Does VEOveneht accept collaborations or sponsorships?
						</h2>
						<p className="text-base text-gray-800">
							We are open to collaborations and sponsorships. Please contact us
							directly for a quote or more information.
						</p>
					</div>

					<div>
						<h2 className="text-xl font-bold text-black">
							How do I find a specific post?
						</h2>
						<p className="text-base text-gray-800">
							You can use the search feature on the main page or go directly to
							the appropriate category such as Games, Tutorials, or Technology.
						</p>
					</div>
				</div>
