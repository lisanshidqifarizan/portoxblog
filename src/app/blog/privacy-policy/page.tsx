...
export default function PrivacyPolicy() {
	return (
		<div className="max-w-4xl mx-auto mt-10 p-6 bg-white border-4 border-black shadow-[6px_6px_0_0_#000]">
			...
			<p className="mb-4">
				We keep data only as long as needed. You may request deletion or access
				anytime via your account or contacting us.
			</p>
			...
			<p className="mb-4">
				We do not collect data from children under 13 knowingly. If found, such
			...
			<p>
				Email:{" "}
				<a
					href="mailto:veoveneht@gmail.com"
					className="underline text-blue-600"
				>
					veoveneht@gmail.com
				</a>
